            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="overflow-x-auto p-6">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr>
                                <th class="px-4 py-3 text-left text-xs font-medium uppercase text-gray-500">Departamento</th>
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-right text-sm">
                                        <div class="flex justify-end gap-3">
                                            <a href="<?php echo e(route('departments.show', $department)); ?>" class="text-gray-600 hover:text-gray-900">
                                                Ver
                                            </a>

                                            <a href="<?php echo e(route('departments.edit', $department)); ?>" class="text-indigo-600 hover:text-indigo-900">
                                                Editar
                                            </a>
                                            ...
                                            <form
                                                ...
                                                method="POST"
                                                onsubmit="return confirm('Deseja realmente remover este departamento?')"
                                            >
                                                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/departments/index.blade.php ENDPATH**/ ?>